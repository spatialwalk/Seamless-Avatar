'''
modified from:
https://github.com/DiffPoseTalk/DiffPoseTalk/blob/main/models/hubert.py 
'''
from transformers import HubertModel
from transformers.modeling_outputs import BaseModelOutput
from .util_audio_encoder import linear_interpolation
...
class HubertModel(HubertModel):
    ...
    def forward(self, input_values, output_fps=FPS, attention_mask=None, output_attentions=None,
